...
const COUNTRIES: Record<string, CountryData> = {
  portugal: { name: "Portugal", flag: "🇵🇹", slug: "portugal", continent: "Europe", capital: "Lisbon", language: "Portuguese", currency: "EUR (€)", costIndex: "Low-Medium", avgRent: "$900/mo (1BR, Lisbon center)", safety: "Very Safe (Index: 82)", visa: "D7 Passive Income Visa", visaTime: "3-6 months", taxHighlight: "NHR regime: 20% flat tax on Portuguese income for 10 years", climate: "Mediterranean — 300+ sunny days/year", internet: "Fast (100+ Mbps fiber)", healthcare: "Excellent public (SNS) + private options", highlights: ["Golden Visa program (real estate or fund investment)", "Path to EU citizenship in 5 years", "One of the best digital nomad hubs in Europe", "Affordable compared to Western Europe", "World-class food and wine scene"], whyMove: "Portugal has become the #1 destination for expats in Europe. With its NHR tax regime, affordable cost of living, beautiful coastline, and path to EU citizenship, it offers an unmatched combination of quality of life and financial advantages.", lifestyle: "Expect a relaxed pace of life, incredible seafood, world-class surfing, and a thriving expat community in Lisbon and Porto. The Algarve offers stunning beaches, while smaller cities like Braga and Coimbra provide authentic Portuguese living at even lower costs.", searchTerms: ["move to portugal", "relocate to portugal", "portugal d7 visa", "portugal golden visa", "living in portugal", "portugal cost of living", "portugal nhr tax"] },
  ...
  greece: { name: "Greece", flag: "🇬🇷", slug: "greece", continent: "Europe", capital: "Athens", language: "Greek", currency: "EUR (€)", costIndex: "Low", avgRent: "$550/mo (1BR, Athens center)", safety: "Safe (Index: 74)", visa: "Golden Visa / Digital Nomad Visa", visaTime: "2-4 months", taxHighlight: "7% flat tax on foreign income for retirees. 50% tax reduction for new workers.", climate: "Mediterranean — 250+ sunny days/year", internet: "Good (50+ Mbps)", healthcare: "Good public + affordable private", highlights: ["Golden Visa from €250K (lowest in EU)", "7% flat tax for foreign retirees", "50% income tax reduction for workers relocating", "Stunning islands and coastline", "Very affordable by European standards"], whyMove: "Greece offers the lowest Golden Visa threshold in the EU, exceptional tax incentives for both retirees and workers, and one of the most affordable costs of living in Europe — all wrapped in stunning natural beauty.", lifestyle: "Island life, ancient history, fresh Mediterranean cuisine, and a warm social culture. Athens is a vibrant modern city, while islands like Crete, Corfu, and the Cyclades offer paradise living. The Greek pace of life is relaxed and community-oriented.", searchTerms: ["move to greece", "relocate to greece", "greece golden visa", "living in greece", "greece cost of living", "greece digital nomad visa"] },
