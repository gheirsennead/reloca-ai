    ...
    <section className="pt-28 pb-16 sm:pt-36 sm:pb-24 px-4 bg-[#fafaf9]">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="mt-4 text-sm text-gray-500 font-medium">
          Full report: <s className="text-gray-400">$49</s> <span className="text-[#1a365d] font-bold">$29</span> — Launch Special (ends April 5th)
        </p>
        <div className="mt-4">
          <ReportPreviewButton />
        </div>
...
const steps = [
  ...
  },
  {
    ...
    desc: "Instant free summary with your top 3 country matches — or unlock the full 16-section report for just $29 (normally $49).",
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    a: "No. The free summary gives you your top 3 matches and estimated costs. The full report (normally $49, currently $29 launch special until April 5th) goes much deeper — visa options, property analysis, tax implications, personalized timeline, and a downloadable PDF.",
  },
  {
