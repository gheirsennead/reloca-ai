...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: '[TO BE TRANSLATED]',
    description: '[TO BE TRANSLATED]',
    url: 'https://reloca.ai/fr/blog/quit-travail-demenage-etranger-25-ans-expatrie',
    type: 'article',
    siteName: 'Reloca.ai',
...
export default function QuitTravailDemenageEtranger25AnsExpatrieArticle() {
  return (
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '[TO BE TRANSLATED]', url: 'https://reloca.ai/fr/blog/quit-travail-demenage-etranger-25-ans-expatrie' },
        ]}
      />
