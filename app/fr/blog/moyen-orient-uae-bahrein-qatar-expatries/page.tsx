...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: '[TO BE TRANSLATED]',
    description: '[TO BE TRANSLATED]',
    url: 'https://reloca.ai/fr/blog/moyen-orient-uae-bahrein-qatar-expatries',
    type: 'article',
    siteName: 'Reloca.ai',
...
export default function MoyenOrientUaeBahreinQatarExpatriesArticle() {
  return (
    &lt;>
      &lt;BreadcrumbSchema
        items={[
          ...
          { name: '[TO BE TRANSLATED]', url: 'https://reloca.ai/fr/blog/moyen-orient-uae-bahrein-qatar-expatries' },
        ]}
      />
