...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: '[TO BE TRANSLATED]',
    description: '[TO BE TRANSLATED]',
    url: 'https://reloca.ai/fr/blog/regles-residency-paraguay-2026',
    type: 'article',
    siteName: 'Reloca.ai',
...
export default function ReglesResidencyParaguay2026Article() {
  return (
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '[TO BE TRANSLATED]', url: 'https://reloca.ai/fr/blog/regles-residency-paraguay-2026' },
        ]}
      />
