...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: '[TO BE TRANSLATED]',
    description: '[TO BE TRANSLATED]',
    url: 'https://reloca.ai/fr/blog/portugal-ifici-tax-regime-2026-fr',
    type: 'article',
    siteName: 'Reloca.ai',
...
export default function PortugalIficiTaxRegime2026FrArticle() {
  return (
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: '[TO BE TRANSLATED]', url: 'https://reloca.ai/fr/blog/portugal-ifici-tax-regime-2026-fr' },
        ]}
      />
